...
def home(request):
  ...
  '''
      Handles request to render the home page at ui/base.html or ui/home_modern.html
      ...
      or ui/home_modern.html template based on the 'modern' query parameter.
  '''
  user = request.user

  if request.method == "GET":
    # Check if modern UI is requested via query parameter
    use_modern = request.GET.get('modern', 'true').lower() == 'true'
    ...
    # Use modern template by default, fallback to old template if requested
    template = 'aushadha_ui/home_modern.html' if use_modern else 'aushadha_ui/base.html'
