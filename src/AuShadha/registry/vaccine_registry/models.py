...
from aushadha_base_models.models import (
        AuShadhaBaseModel, 
...
class VaccineData(AuShadhaBaseModel):
    ...
    vaccine_fk = models.ForeignKey('VaccineDetail', on_delete=models.CASCADE)
...
class VaccineCVXToMVX(AuShadhaBaseModel):
    ...
    cvxcode = models.ForeignKey('VaccineDetail', on_delete=models.CASCADE)
