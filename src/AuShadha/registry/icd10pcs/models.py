...
class TableAxisLabel(models.Model):
    ...
    label_fk = models.ForeignKey('AppTxt', related_name='+', on_delete=models.CASCADE)
    title_fk = models.ForeignKey('AppTxt', related_name='+', on_delete=models.CASCADE)
...
class RowAxisLabel(TableAxisLabel, TableAxisLabelMixin):
    row_id = models.ForeignKey('CodePageRow', on_delete=models.CASCADE)
...
class Operation(TableAxisLabel,AuShadhaBaseModel):
    defn_fk = models.ForeignKey('AppTxt', related_name='+', on_delete=models.CASCADE)
